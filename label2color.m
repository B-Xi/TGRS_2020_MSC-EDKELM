...
switch lower(data_name)
    ...
    case 'india'
        ...
        map=[140 67 46;0 0 255;255 100 0;0 255 200;164 75 155;101 174 255;118 254 254; 60 91 112;255,255,0;255 255 225;255 0 255;100 0 255;0 200 254;0 255 0;171 175 80;101 193 60];
    ...
    case 'ksc'
        %         map=[0 0 255;255 100 0;0 255 134;150 70 150; 100 150 255;60 90 114;255 255 125;255 0 255;100 0 255;1 170 255;0 255 0;175 175 82;100 190 56;140 67 46;115 255 172;255 255 0];
        %             map=[140 67 46;0 0 255;255 100 0;0 255 123;164 75 155;101 174 255;118 254 172; 60 91 112;255,255,0;255 255 125;255 0 255;100 0 255;0 172 254;0 255 0;171 175 80;101 193 60];
        map=[140 67 46;0 0 255;255 100 0;0 255 200;164 75 155;101 174 255;118 254 254; 60 91 112;255,255,0;255 255 225;255 0 255;100 0 255;0 200 254];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
    ...
    case 'yancheng'
        %         map=[0 0 255;255 100 0;0 255 134;150 70 150; 100 150 255;60 90 114;255 255 125;255 0 255;100 0 255;1 170 255;0 255 0;175 175 82;100 190 56;140 67 46;115 255 172;255 255 0];
        %             map=[140 67 46;0 0 255;255 100 0;0 255 123;164 75 155;101 174 255;118 254 172; 60 91 112;255,255,0;255 255 125;255 0 255;100 0 255;0 172 254;0 255 0;171 175 80;101 193 60];
        map=[140 67 46;0 0 255;255 100 0;0 255 200;164 75 155;101 174 255;118 254 254; 60 91 112;255,255,0;255 255 225;255 0 255;100 0 255;0 200 254;0 255 0;171 175 80;101 193 60;192 192 192;255 0 0;153 102 0;153 51 255];
